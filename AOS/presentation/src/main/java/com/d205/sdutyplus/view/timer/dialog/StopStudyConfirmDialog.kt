...
class StopStudyConfirmDialog : DialogFragment() {
    private lateinit var binding: StopStudyConfirmDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = StopStudyConfirmDialog.inflate(inflater, container, false)
