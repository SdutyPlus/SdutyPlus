...
public class QFeedLike extends EntityPathBase<FeedLike> {
    ...
    private static final long serialVersionUID = 2035441121L;
    ...
    public final com.d205.sdutyplus.domain.user.entity.QUser user;
    ...
    public QFeedLike(Class<? extends FeedLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.d205.sdutyplus.domain.user.entity.QUser(forProperty("user")) : null;
    }
