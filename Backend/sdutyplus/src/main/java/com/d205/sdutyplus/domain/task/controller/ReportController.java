...
public class ReportController {
    ...
    public ResponseEntity<ResponseDto> getReportTotalTime(@ApiIgnore Authentication auth, @PathVariable String date){
        Long userSeq = (Long)auth.getPrincipal();
        String totalTime = taskService.getReportTotalTime(userSeq, date);
